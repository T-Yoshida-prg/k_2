...
public class AppTest 
{
     ...
     * Rigorous Test :-)
     */
    //curl https://example.com 相当のことができる機能(完成)
    @Test
    ...
    //curl -o file https://example.com 相当のことができる機能(完成かどうか怪しい)
    @Test
   ...
   //curl -v  https://example.com 相当のことができる機能(未完成)
    @Test
    ...
    //curl -X POST https://example.com 相当のことができる機能(完成)
    @Test
    ...
    //curl -X POST -d "key=value" https://example.com 相当のことができる機能(完成)
    @Test
